...
Public Function ReadMem() As String
    ...
    Call lstrcpyn(ByVal sData2, ByVal lShareData2, LenStr)
    ReadMem = sData2
End Function

Private Sub WriteMem(ByVal Text)
    sData2 = Text
    Call lstrcpyn(ByVal lShareData2, ByVal sData2, LenStr)
End Sub
...
If Text = "Protect.ReLoad" Then
Form_Map.ReLoad
End If
If Text = "Protect.Unload" Then
Unload Form_Map
End If
