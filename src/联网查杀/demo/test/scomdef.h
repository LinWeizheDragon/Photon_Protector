...
#include <GuidDef.h>
	...
	#ifndef KSE_NOT_DEPEND_ON_KXE
		#define KIS_SCOM_ROOT_KEY       "SOFTWARE\\Kingsoft\\KISCommon\\KXEngine\\CLASSES_ROOT"
		#define KIS_SCOM_ROOT_KEY_W    L"SOFTWARE\\Kingsoft\\KISCommon\\KXEngine\\CLASSES_ROOT"
	#else   // KSE_NOT_DEPEND_ON_KXE
		#define KIS_SCOM_ROOT_KEY       "SOFTWARE\\Kingsoft\\KIS\\CLASSES_ROOT"
		#define KIS_SCOM_ROOT_KEY_W    L"SOFTWARE\\Kingsoft\\KIS\\CLASSES_ROOT"
	#endif  // KSE_NOT_DEPEND_ON_KXE

	#define KIS_SCOM_CLSID_KEY          "SOFTWARE\\Kingsoft\\KISCommon\\KXEngine\\CLASSES_ROOT\\CLSID"
	#define KIS_SCOM_CLSID_KEY_W       L"SOFTWARE\\Kingsoft\\KISCommon\\KXEngine\\CLASSES_ROOT\\CLSID"
#else
	#define KIS_SCOM_ROOT_KEY           "SOFTWARE\\Kingsoft\\AntiVirus_Beta\\KXEngine\\CLASSES_ROOT"
	#define KIS_SCOM_ROOT_KEY_W        L"SOFTWARE\\Kingsoft\\AntiVirus_Beta\\KXEngine\\CLASSES_ROOT"
	#define KIS_SCOM_CLSID_KEY          "SOFTWARE\\Kingsoft\\AntiVirus_Beta\\KXEngine\\CLASSES_ROOT\\CLSID"
	#define KIS_SCOM_CLSID_KEY_W       L"SOFTWARE\\Kingsoft\\AntiVirus_Beta\\KXEngine\\CLASSES_ROOT\\CLSID"
#endif
